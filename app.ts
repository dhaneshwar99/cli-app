...
function parseExcelToJson(filePath: string): any[] {
...
function writeJsonToFile(data: any[], outputFilePath: string): void {
...
function rectifyEmail(email: string) {
    // Trim whitespace
    email = email.trim();
...
function rectifyPhoneNumber(phoneNumber: any) {
...
function rectifyURL(url: string) {
    try {
...
function rectifyNumericId(id: string) {
    // Remove non-digit characters
...
function rectifyLatitude(latitude: any) {
...
function rectifyLongitude(longitude: any) {
    // Remove non-digit characters and trim whitespace
